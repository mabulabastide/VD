...
class TCPDF_EasyTable extends TCPDF{
    ...
    */
    ...
    public function Header() {
      ...
      // Page number
      $this->Cell(0, 10, 'GAEC DE LABASTIDE -  FACTURE  - Divers clients vente directe', 0, false, 'C', 0, '', 0, false, 'T', 'M');
      }
    ...
    public function Footer() {
        ...
        // Page number
        $this->Cell(0, 10, ' GAEC de Labastide - Page '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
    }
